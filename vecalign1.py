...
from extract_sentences import mined_sentences
...
#        print(stack[0]['final_alignments'][6][0][0])
#        print(stack[0]['final_alignments'][6][1][1])
#        with open(r"bleualign_data\dev.de", encoding='utf-8-sig') as source:
#            lines = source.readlines()
#            print(lines[stack[0]['final_alignments'][6][0][0]])
        mined_sentences(stack[0]['final_alignments'], stack[0]['alignment_scores'], src_file, tgt_file, src_file[:-9] + "_lines.txt", tgt_file[:-9] + "_lines.txt")
